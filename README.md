...
- [lxc/terraform-provider-incus](https://github.com/lxc/terraform-provider-incus) ([v1.0.1](https://github.com/lxc/terraform-provider-incus/releases/tag/v1.0.1), 2 days ago) - Incus provider for Terraform/OpenTofu
- [lxc/incus](https://github.com/lxc/incus) ([v6.19.1](https://github.com/lxc/incus/releases/tag/v6.19.1), 1 week ago) - Powerful system container and virtual machine manager 
...
- [Migrating Kubernetes clusters with Velero and Flux](https://luissimas.github.io/blog/kubernetes-backups-velero/) (6 days ago)
