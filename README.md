...
- [lxc/terraform-provider-incus](https://github.com/lxc/terraform-provider-incus) ([v1.0.1](https://github.com/lxc/terraform-provider-incus/releases/tag/v1.0.1), 1 day ago) - Incus provider for Terraform/OpenTofu
...
- [Migrating Kubernetes clusters with Velero and Flux](https://luissimas.github.io/blog/kubernetes-backups-velero/) (5 days ago)
